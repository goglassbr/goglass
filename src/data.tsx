...
export const depositions = [
  {     
    name: 'Manuela Cajado',
    job: 'Médica',
    text: 'Meu celular caiu no chão no fim de semana, a Goglass pegou meu celular em casa, me deixou um reserva e em menos de 24 horas eu já estava com meu celular novinho em folha! Recomendo para todos!',
    insta: '@elas_fit',
    instalink: 'https://www.instagram.com/elas_fit/',
    video: 'https://www.youtube.com/embed/WySyt477FU4',
    img: 'Manuela-Cajado-img.jpg',
    imgvideo: 'Manuela-Cajado-imgvideo.png',
  },
  {     
    name: 'Luccas Tiberio',
    job: 'Cantor / Compositor',
    text: 'Fiquei surpreso com o atendimento da empresa! Eles levam em QUALQUER lugar com eficiência e ainda deixa um celular reserva. Recomendo!',
    ...
    img: 'Luccas-Tiberio-img.jpg',
    imgvideo: 'Luccas-Tiberio-imgvideo.png',
  },
  {     
    name: 'Ane Azevedo Riccó',
    text: 'Buscaram meu celular em casa, me emprestaram um celular reserva! Foi a solução dos meus problemas. Vieram em casa no mesmo dia, estou apaixonada!',
    insta: '@ane.ricco',
    instalink: 'https://www.instagram.com/ane.ricco/',
    video: 'https://www.youtube.com/embed/JbIdEjXDU_A',
    img: 'Ane-Azevedo-img.jpg',
    imgvideo: 'Ane-Azevedo-imgvideo.png',
  },
  {     
    name: 'Isabella Motta',
    text: 'A Goglass é um dos amores da minha life! Não posso deixar de indicar para vocês, confio de olhos fechados, real! Em menos de 24 horas recebi meu celular novinho em segurança sem sair de casa.',
    insta: '@iisabellamotta',
    instalink: 'https://www.instagram.com/iisabellamotta/',
    video: 'https://www.youtube.com/embed/A7eG8P1YFP0',
    img: 'Isabella-Motta-img.jpg',
    imgvideo: 'Isabella-Motta-imgvideo.png',
  }
];

export const QeAData = [
    [
      { 
        question: 'Quais serviços vocês fazem?',
        answer: 'Nós efetuamos a troca de vidro dos aparelhos Samsung (linhas A, S e Note) e Apple (iPhone e Watch).',
      },
      { 
        question: 'Vocês trabalham com celulares apagados ou com problemas em placa?',
        answer: 'Não, nossos serviços são realizados em aparelhos com apenas o vidro trincado. Touch, display e funcionamento do aparelho têm que estar 100%, sem defeito ou mal funcionamento.',
      },
      { 
        question: 'Como faço para agendar serviço com a Goglass?',
        answer: 'Basta completar todo o atendimento automático do Go que receberá todas as instruções e ao fechar o pedido um dos nossos consultores irá falar com você.',
      },
      { 
        question: 'Quanto tempo dura o serviço?',
        answer: 'Nosso prazo para troca de vidro é de 48 horas úteis, deixando e retirando o aparelho no laboratório. Caso opte pelo serviço delivery (leva e traz) acrescenta 24 horas úteis no prazo.',
      },
      { 
        question: 'Os produtos da Goglass são originais?',
        answer: 'Nossos produtos não são originais, pois os fabricantes da Samsung e Apple possuem contrato de exclusividade. Nossos fornecedores passam por um árduo processo de seleção e são de tão boa qualidade quanto os originais, sendo demonstrado pela alta avaliação dos nossos clientes.',
      },
      { 
        question: 'A Goglass é uma loja autorizada da Samsung/Apple?',
        answer: 'Somos uma loja especializada nestas marcas mas não somos autorizadas (pertencentes do grupo). Nosso intuito é justamente desenvolver melhores tecnologias para baratear os preços abusivos cobrados pelas autorizadas.',
      },
      { 
        question: 'Como funciona o Leva e Traz?',
        answer: 'Nosso colaborador exclusivo vai até você, no endereço de sua preferência, realiza todos os testes do aparelho contigo, leva o aparelho para nosso laboratório, realizamos o conserto do seu aparelho, com o aparelho pronto o colaborador vai ao seu encontro no endereço passado para devolução do aparelho e pagamento do serviço.',
      },
      { 
        question: 'Onde o Leva e Traz atende e quanto custa?',
        answer: 'O Leva e Traz atende em Salvador e Lauro de Freitas e está gratuíto para ambos! Demais localidades podem entregar o aparelho pessoalmente em nosso laboratório ou nos enviar por Sedex.',
      },
      { 
        question: 'Moro em outra cidade, como faço?',
        answer: 'Fique tranquilo(a), temos muitos clientes de outras cidades e estados. Nesses casos, eles nos enviam o aparelho por correios (sedex ou pac), aos cuidados de nossa empresa e recebemos aqui. Após o recebimento, verificamos o aparelho, fazemos todos os testes, gravamos um vídeo de confirmação para o cliente, realizamos o serviço contratado e após outro vídeo de confirmação enviamos de volta.',
      },
      {
        question: 'Qual a forma de pagamento?',
        answer: <div>Parcelamos em até 3x sem juros para serviços abaixo de R$600 e em até 5x sem juros para serviços maiores que R$600. Aceitamos todos os cartões de crédito e débito. Para pagamentos à vista o desconto é de 5%.<br/><br/>
        Em caso de delivery, o colaborador levará a máquina e o pagamento será realizado após o conserto do aparelho na devolução.<br/><br/>        
        Para pagamentos à distância (Correios), poderá ser feito por transferência ou PicPay.</div>,
      },
      { 
        question: 'O serviço tem garantia?',
        answer: <div>A garantia na troca da tela é de 90 dias contados da substituição, cobrindo defeitos ou vícios exclusivos do produto ou procedimento de troca.<br/><br/>
        Lembrando que não cobrimos queda, mal uso ou problemas em componentes não trocados.</div>,
      },
      { 
        question: 'Eu perco a garantia de fábrica se trocar o vidro com a Goglass?',
        answer: 'Qualquer serviço realizado fora da rede autorizada da Samsung / Apple acarreta na perda da garantia.',
      },
      { 
        question: 'Fui em outro local e me disseram que não se troca vidro do aparelho e sim a tela completa (vidro+display+touch), procede?',
        answer: 'Não! A maioria dos locais não fazem o procedimento de troca de vidro por ser muito mais técnico e com necessidade de alto investimento em maquinário. Como trabalham com a troca de tela (que é mais simples pra eles) informam que não se troca apenas o vidro numa tentativa antiética de que o cliente realize a troca de tela com ele.',
      },
    ],
    [
      { 
        question: 'Faça Backup!',
        answer: 'Sempre efetuar o backup dos seus dados. Em todo processo de reparo existe risco.',
      },
      { 
        question: 'Esteja presente e disponível no horário marcado para coleta.',
        answer: 'Nos esforçamos ao máximo para garantir que todos os clientes sejam atendidos dentro do prazo planejado. Marcou um horário no nosso Leva e Trás, certifique-se de estar presente para que possamos garantir seu prazo. Pedimos então, caso tenha um imprevisto, que nos avise com o máximo de antecedência para tentarmos ajustar o seu horário.',
      },
      { 
        question: 'Se precisar remarcar, avise.',
        answer: 'Nosso sistema de Leva e Trás trabalha com rotas. Qualquer remarcação no mesmo dia, acarretará em uma nova cobrança do valor para o Leva e Trás.',
      },
      { 
        question: 'Trazer o telefone carregado.',
        answer: 'Sempre que possível trazer o aparelho carregado, desta forma o seu atendimento será feito de forma mais rápida. Já que, será necessário realizar teste com o aparelho na entrada e na saída.',
      },
    ],
    [
      { 
        question: 'Resistência à água',
        answer: 'Após a abertura do seu aparelho sua capacidade de proteção contra água é reduzida. Redobre os cuidados com seu aparelho e não leve para áreas molhadas.',
      },
      { 
        question: 'Cuidados extras',
        answer: <div>Muitos aparelhos que chegam até a gente foram trincado por acidentes bobos. Eis alguns que você pode evitar:<br/><br/><br/>
        1- Não coloque o celular no bolso traseiro ou apertado. Não guarde seu celular junto a outros objetos.<br/><br/>
        2- Não exponha o celular a altas temperaturas (deixar no carro ou com exposição direta ao sol).<br/><br/>
        3- Não descanse seu celular com a tela virada para baixo seja qual for a superfície.<br/><br/>
        4- Sempre proteja o celular com uma película de vidro de alta qualidade e capa protetora!<br/><br/>
        5- Mesmo seguindo tudo isso, acidentes são inevitáveis. Ao trincar seu celular, não espere o problema piorar e acabar perdendo o display/placa! Traga novamente para gente e ganhe 10% de desconto por já ser nosso cliente!</div>,
      },
    ],
  ];
